...
def mes():
    ...
    for i in range(1, num_months + 1):
        folder_name = f'{user_profile}\\OneDrive - FleetCor\\DEV\\Tests\\Test_Enviroment\\month{i:02}'
...
def dia():
    ...
    for day in range(1, num_days + 1):
        folder_name = f'{user_profile}\\OneDrive - FleetCor\\DEV\\Tests\\Test_Enviroment\\month04\\abr{day:02}'
        os.makedirs(folder_name, exist_ok=True)
        print(f'Pasta "{folder_name}" criada com sucesso.')
